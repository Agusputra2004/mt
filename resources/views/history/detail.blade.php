                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5>Pesanan anda telah sukses dicheck out selanjutnya untuk pembayaran silahkan transfer melalui rekening <strong>Bank BRI Nomor Rekening : 43247-783595-647</strong>dengan nominal : <strong>Rp. {{ number_format($pesanan->jumlah_harga) }}</strong></h5>
                        </div>
                    </div>
                    <div class="card mt-2">
